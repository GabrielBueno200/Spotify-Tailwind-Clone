...
const PlaylistCard = ({ title, artists, imageSrc }: IPlaylistCard) =>
    <a href="#" className="bg-white/5 p-2 rounded flex flex-col gap-2 hover:bg-white/10">
        <div className="relative group">
            ...
            <button className="w-14 h-14 flex items-center justify-center pl-1 rounded-full bg-green-500 text-zinc-800 ml-auto mx-2 my-1 invisible group-hover:visible absolute bottom-0 right-0 transition-all group-hover:-translate-y-2 opacity-0 group-hover:opacity-100">
